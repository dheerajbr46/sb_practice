...
import static com.eazybytes.loans.constants.LoanConstants.*;
...
public class LoansController {
    ...
    public LoansController(ILoansService loansService,
                           LoansContactInfoDto cardsContactInfoDto) {
    ...
    @Operation(
            ...
            description = "REST API to fetch build version info of Loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to fetch contact information of Loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<LoansContactInfoDto> getContactInfo() {
        LOGGER.debug("getContactInfo called");
        return ResponseEntity
                .status(HttpStatus.OK)
